    ...
    <div class="container mt-4">
        <div class="row align-items-center">
            <div class="col-md-10 mx-auto col-lg-5">
                <h1 class="text-center mt-4 p-4">Login</h1>
                <form class="p-4 p-md-5 border rounded-3 bg-light" method="POST" action="../control/controleUsuario.php">
                    ...
                    <button class="btn btn-lg btn-dark" type="submit" name="opcao" value="Entrar">Entrar</button>
                    <a class="row mt-2 px-3 text-dark" href="cadastrarUsuario.php" class="btn btn-secondary">Cadastrar</a>
                </form>
